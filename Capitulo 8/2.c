...
void main(void)
{
    ...
    /* Observa que las variables *a3, *a4y *a5se declaran como apuntadores de
    ...
    Lectura(a5);     /* En este caso se pasa el apuntador de tipo estructura alumnoa 5a la función Lectura. */
