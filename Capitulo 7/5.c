...
void main(void)
{
    ...
    gets(cad0);
    i = atoi(cad0);   
    /* La función atoi convierte una cadena de caracteres que contiene númerosa 
    ...
    printf("\n%s \t %d", cad0, i+3);
    /* Se imprime el valor de i+3para demostrar que iya fue convertido a un entero.*/
    
    printf("\nIngrese una cadena de caracteres: ");
    gets(cad0);
    d = atof(cad0);
    /* La función atofconvierte una cadena de caracteres que contiene números
    ...
    puts(cad1);l
     ...
     = atol(cad0);
     /* La función atolconvierte una cadena de caracteres que contiene números a
     ...
     /* La función strtolconvierte una cadena de caracteres que contiene números a
