...
void main(void)
{
    ...
    p1 = getchar();
    if(isalpha (p1))   /* La función isalpharegresa 1 si p1 es una letra y 0 en caso contrario. */
    ...
    La función isupper, por otra parte, regresa 1 si p1es una letra mayúscula
