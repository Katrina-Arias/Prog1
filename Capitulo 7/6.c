...
/* Funciones de la biblioteca string.h para el manejo de cadenas decaracteres. */
...
void main(void)
{
    ...
    strcpy(cad1, cad0);
    /* La función strcpypermite copiar una cadena de caracteres completa. En este
    caso se copia la cadena cad0a cad1. Si el espacio reservado para cad1es
    ...
    reservado para cad2es menor que lo que se pretende copiar, se genera
    ...
    strcat(cad0, cad3);
    /* La función strcatpermite incorporar una cadena de caracteres a otra
    cadena dada. En este caso se agrega la cadena cad3a cad0. Si el espacio
    reservado para cad0es menor a lo que se debe almacenar se genera un error
    de ejecución. */
    ...
    a cad2. Si el espacio de cad2es menor a lo que se debe almacenar ocurre
    ...
    /* La función strstrse utiliza para localizar una cadena de caracteres dentro
