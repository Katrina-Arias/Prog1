...
{
    char p1, p2, p3 = '$';
    /* Declaración de las variables tipo caracter p1, p2y p3. Observa que ap3 se le
    asigna el símbolo $. */
    printf("\nIngrese un caracter: ");
    ...
    printf("\nEl caracter p3 es: ");
    putchar(p3);   /* Se utiliza la función putcharpara escribir el caracter almacenado en p3. */
    printf("\n");
    ...
    printf("%c", p2);
    /* Se puede utilizar printf con el formato de variable %cpara escribir un
    caracter. */
}